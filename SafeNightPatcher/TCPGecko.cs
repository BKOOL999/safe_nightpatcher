...
namespace SafeNightPatcher
{
    ...
    public class TCPGecko
    {
        ...
        public void Dump(UInt32 startdump, UInt32 enddump, Stream[] saveStream)
        {
            ...
            if (SafeNightPatcher.ValidMemory.rangeCheckId(startdump) != SafeNightPatcher.ValidMemory.rangeCheckId(enddump))
            {
                enddump = SafeNightPatcher.ValidMemory.ValidAreas[SafeNightPatcher.ValidMemory.rangeCheckId(startdump)].high;
            }

            if (!SafeNightPatcher.ValidMemory.validAddress(startdump)) return;
        ...
        */
        ...
        {
            if (!SafeNightPatcher.ValidMemory.validAddress(address))
            {
                return 0;
            }
